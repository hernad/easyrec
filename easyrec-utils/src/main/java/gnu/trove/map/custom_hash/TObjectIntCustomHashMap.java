...
public class TObjectIntCustomHashMap<K> extends TCustomObjectHash<K>
     ...
     */
    public TObjectIntCustomHashMap( HashingStrategy<K> strategy ) {
        super( strategy );
    }
     ...
     */
    public TObjectIntCustomHashMap( HashingStrategy<K> strategy, int initialCapacity ) {
     ...
     */
    public TObjectIntCustomHashMap( HashingStrategy<K> strategy, int initialCapacity,
		float loadFactor, int noEntryValue ) {
