...
public class TObjectShortCustomHashMap<K> extends TCustomObjectHash<K>
     ...
     */
    public TObjectShortCustomHashMap( HashingStrategy<K> strategy ) {
        super( strategy );
    }
     ...
     */
    public TObjectShortCustomHashMap( HashingStrategy<K> strategy, int initialCapacity ) {
     ...
     */
    public TObjectShortCustomHashMap( HashingStrategy<K> strategy, int initialCapacity,
		float loadFactor, short noEntryValue ) {
     ...
     */
    public TObjectShortCustomHashMap( HashingStrategy<K> strategy, TObjectShortMap<K> map ) {
