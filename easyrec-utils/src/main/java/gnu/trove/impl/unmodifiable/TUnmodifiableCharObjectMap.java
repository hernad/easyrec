...
public class TUnmodifiableCharObjectMap<V> implements TCharObjectMap<V>, Serializable {
	...
	public void putAll( TCharObjectMap<V> m ) { throw new UnsupportedOperationException(); }
	...
	public boolean retainEntries( TCharObjectProcedure<V> procedure ) { throw new UnsupportedOperationException(); }
}
