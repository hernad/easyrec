...
public class TUnmodifiableIntObjectMap<V> implements TIntObjectMap<V>, Serializable {
	...
	public void putAll( TIntObjectMap<V> m ) { throw new UnsupportedOperationException(); }
	...
	public boolean retainEntries( TIntObjectProcedure<V> procedure ) { throw new UnsupportedOperationException(); }
}
