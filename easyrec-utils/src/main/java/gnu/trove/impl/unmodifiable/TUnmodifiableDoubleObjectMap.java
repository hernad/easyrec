...
public class TUnmodifiableDoubleObjectMap<V> implements TDoubleObjectMap<V>, Serializable {
	...
	public void putAll( TDoubleObjectMap<V> m ) { throw new UnsupportedOperationException(); }
	...
	public boolean retainEntries( TDoubleObjectProcedure<V> procedure ) { throw new UnsupportedOperationException(); }
}
