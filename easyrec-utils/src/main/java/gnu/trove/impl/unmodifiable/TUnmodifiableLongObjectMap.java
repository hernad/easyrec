...
public class TUnmodifiableLongObjectMap<V> implements TLongObjectMap<V>, Serializable {
	...
	public void putAll( TLongObjectMap<V> m ) { throw new UnsupportedOperationException(); }
	...
	public boolean retainEntries( TLongObjectProcedure<V> procedure ) { throw new UnsupportedOperationException(); }
}
