...
public class TUnmodifiableFloatObjectMap<V> implements TFloatObjectMap<V>, Serializable {
	...
	public void putAll( TFloatObjectMap<V> m ) { throw new UnsupportedOperationException(); }
	...
	public boolean retainEntries( TFloatObjectProcedure<V> procedure ) { throw new UnsupportedOperationException(); }
}
