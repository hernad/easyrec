...
public class TUnmodifiableShortObjectMap<V> implements TShortObjectMap<V>, Serializable {
	...
	public void putAll( TShortObjectMap<V> m ) { throw new UnsupportedOperationException(); }
	...
	public boolean retainEntries( TShortObjectProcedure<V> procedure ) { throw new UnsupportedOperationException(); }
}
