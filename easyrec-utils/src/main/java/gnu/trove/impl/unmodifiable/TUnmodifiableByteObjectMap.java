...
public class TUnmodifiableByteObjectMap<V> implements TByteObjectMap<V>, Serializable {
	...
	public void putAll( TByteObjectMap<V> m ) { throw new UnsupportedOperationException(); }
	...
	public boolean retainEntries( TByteObjectProcedure<V> procedure ) { throw new UnsupportedOperationException(); }
}
