 ...
 */
public class GeneratorStatisticsTag implements Tag {
    private PageContext pageContext;
    private Tag parent;
    private GeneratorStatistics stats;
    private DisplayService displayService;

    public void setStats(GeneratorStatistics generatorStatistics) {
        this.stats = generatorStatistics;
    }

    public GeneratorStatisticsTag() {
        super();
    }
    ...
    public int doEndTag() throws javax.servlet.jsp.JspTagException {
        ...
        try {
            String stringRep = this.displayService.display(this.stats);
