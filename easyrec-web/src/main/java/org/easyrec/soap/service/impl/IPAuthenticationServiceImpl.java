 ...
 */
public class IPAuthenticationServiceImpl implements AuthenticationService {
    ...
    public IPAuthenticationServiceImpl(TenantServiceImpl tenantService) {
    ...
    public Integer authenticateTenant(String tenant, HttpServletRequest request) {
        String accessDomain = request.getRemoteAddr();
        if (logger.isDebugEnabled())
            logger.debug("Trying to authenticate IP '" + accessDomain + "' for tenant '" + tenant + "'");
    ...
    public boolean authenticateTenant(Integer tenantId, HttpServletRequest request) {
        String accessDomain = request.getRemoteAddr();
        if (logger.isDebugEnabled())
            logger.debug("Trying to authenticate IP '" + accessDomain + "' for tenantId '" + tenantId + "'");
