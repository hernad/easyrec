...
public abstract class ItemsRatedGoodByOtherUsersTest extends AbstractApiTest {

    public static class JSON extends ItemsRatedGoodByOtherUsersTest {
        public JSON() throws TestContainerException { super(METHOD_JSON); }
    }

    public static class XML extends ItemsRatedGoodByOtherUsersTest {
    ...
    @Test
    public void itemsRatedGoodByOtherUsers_noParameters_shouldReturnError() {
    ...
    @Test
    public void itemsRatedGoodByOtherUsers_wrongTenant_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
    ...
    @Test
    public void itemsRatedGoodByOtherUsers_wrongApiKey_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
    ...
    @Test
    public void itemsRatedGoodByOtherUsers_onlyApiKeyTenant_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
    ...
    @Test
    public void itemsRatedGoodByOtherUsers_noFilter_shouldReturnRecommendationsOfAllItemTypes() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        ...
        assertThat(json, not(is(nullValue())));
        assertThat(json.getString("action"), is("itemsratedgoodbyotherusers"));
    ...
    @Test
    public void itemsRatedGoodByOtherUsers_filterItemType_shouldReturnRecommendationsOfSpecificItemType() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("itemid", "ITEM_A");
    ...
    @Test
    public void itemsRatedGoodByOtherUsers_filterUser_shouldFilterRecommendationsWhereUserTookAction() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("itemid", "ITEM_A");
    ...
    @Test
    public void itemsRatedGoodByOtherUsers_numberOfResults_shouldTruncateReults() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("itemid", "ITEM_A");
    ...
    public void itemsRatedGoodByOtherUsers_wrongItemType_shouldReturnError() {
        ...
        @SuppressWarnings({"unchecked"})
    @Test
    public void itemsRatedGoodByOtherUsers_wrongRequestedItemType_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("itemid", "ITEM_A");
    ...
    @Test
    public void itemsRatedGoodByOtherUsers_wrongItem_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
    ...
    @Test
    public void itemsRatedGoodByOtherUsers_deactivatedItem_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
