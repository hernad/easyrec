...
public abstract class BuyTest extends AbstractApiTest {

    public static class JSON extends BuyTest {
        public JSON() throws TestContainerException { super(METHOD_JSON); }
    }

    public static class XML extends BuyTest {
        public XML() throws TestContainerException { super(METHOD_XML); }
    }

    public BuyTest(String method) throws TestContainerException {
        super("buy", method);
    }

    @Test
    public void buy_noParameters_shouldReturnError() {
    ...
    @Test
    public void buy_wrongTenant_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
    ...
    @Test
    public void buy_noSessionId_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("itemid", "TEST_A");
    ...
    @Test
    public void buy_noItemId_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("sessionid", "TEST_SESSION");
    ...
    @Test
    public void buy_noItemDescription_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("sessionid", "TEST_SESSION");
    ...
    @Test
    public void buy_noItemUrl_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("sessionid", "TEST_SESSION");
    ...
    @Test
    @ExpectedDataSet("/dbunit/web/rest/expected_buy_2.xml")
    public void buy_withUserIdAndOtherItemTypeAndExtraInfo_shouldCreateViewActionAndItem() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("sessionid", "TEST_SESSION");
