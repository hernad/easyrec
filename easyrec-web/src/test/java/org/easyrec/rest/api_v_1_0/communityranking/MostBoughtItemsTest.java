...
public abstract class MostBoughtItemsTest extends AbstractApiTest {

    public static class JSON extends MostBoughtItemsTest {
        public JSON() throws TestContainerException { super(METHOD_JSON); }
    }

    public static class XML extends MostBoughtItemsTest {
        public XML() throws TestContainerException { super(METHOD_XML); }
    }

    public MostBoughtItemsTest(String method) throws TestContainerException {
        super("mostboughtitems", method);
    }

    @Test
    public void mostBoughtItems_noParameters_shouldReturnError() {
    ...
    @Test
    public void mostBoughtItems_wrongTenant_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
    ...
    @Test
    public void mostBoughtItems_wrongApiKey_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
    ...
    @Test
    public void mostBoughtItems_apiKeyTenant_shouldReturnRecommendations() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        ...
        assertThat(json.getString("action"), is("mostboughtitems"));
    ...
    @Test
    public void mostBoughtItems_numberOfResults_shouldTruncateResult() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
    ...
    @Test
    public void mostBoughtItems_requestedItemType_shouldFilterResults() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
