...
public abstract class OtherUsersAlsoBoughtTest extends AbstractApiTest {

    public static class JSON extends OtherUsersAlsoBoughtTest {
        public JSON() throws TestContainerException { super(METHOD_JSON); }
    }

    public static class XML extends OtherUsersAlsoBoughtTest {
    ...
    @Test
    public void otherUsersAlsoBought_noParameters_shouldReturnError() {
    ...
    @Test
    public void otherUsersAlsoBought_wrongTenant_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
    ...
    @Test
    public void otherUsersAlsoBought_wrongApiKey_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
    ...
    @Test
    public void otherUsersAlsoBought_onlyApiKeyTenant_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
    ...
    @Test
    public void otherUsersAlsoBought_noFilter_shouldReturnRecommendationsOfAllItemTypes() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        ...
        assertThat(json, not(is(nullValue())));
        assertThat(json.getString("action"), is("otherusersalsobought"));
    ...
    @Test
    public void otherUsersAlsoBought_filterItemType_shouldReturnRecommendationsOfSpecificItemType() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("itemid", "ITEM_A");
    ...
    @Test
    public void otherUsersAlsoBought_filterUser_shouldFilterRecommendationsWhereUserTookAction() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("itemid", "ITEM_A");
    ...
    @Test
    public void otherUsersAlsoBought_numberOfResults_shouldTruncateReults() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("itemid", "ITEM_A");
    ...
    @SuppressWarnings({"unchecked"})
    @Test
    public void otherUsersAlsoBought_wrongRequestedItemType_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("itemid", "ITEM_A");
    ...
    @Test
    public void otherUsersAlsoBought_wrongItem_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
    ...
    @Test
    public void otherUsersAlsoBought_deactivatedItem_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
