...
public abstract class ViewTest extends AbstractApiTest {

    public static class JSON extends ViewTest {
        public JSON() throws TestContainerException { super(METHOD_JSON); }
    }

    public static class XML extends ViewTest {
        public XML() throws TestContainerException { super(METHOD_XML); }
    }

    public ViewTest(String method) throws TestContainerException {
        super("view", method);
    }

    @Test
    public void view_noParameters_shouldReturnError() {
    ...
    @Test
    public void view_wrongTenant_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
    ...
    @Test
    public void view_wrongApiKey_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
    ...
    @Test
    public void view_noSessionId_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("itemid", "TEST_A");
    ...
    @Test
    public void view_noItemId_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("sessionid", "TEST_SESSION");
    ...
    @Test
    public void view_noItemDescription_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("sessionid", "TEST_SESSION");
    ...
    @Test
    public void view_noItemUrl_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("sessionid", "TEST_SESSION");
    ...
    @Test
    @ExpectedDataSet("/dbunit/web/rest/expected_view_2.xml")
    public void view_withUserIdAndOtherItemTypeAndExtraInfo_shouldCreateViewActionAndItem() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("sessionid", "TEST_SESSION");
