...
public abstract class MostViewedItemsTest extends AbstractApiTest {

    public static class JSON extends MostViewedItemsTest {
        public JSON() throws TestContainerException { super(METHOD_JSON); }
    }

    public static class XML extends MostViewedItemsTest {
        public XML() throws TestContainerException { super(METHOD_XML); }
    }

    public MostViewedItemsTest(String method) throws TestContainerException {
        super("mostvieweditems", method);
    }

    @Test
    public void mostViewedItems_noParameters_shouldReturnError() {
    ...
    @Test
    public void mostViewedItems_wrongTenant_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
    ...
    @Test
    public void mostViewedItems_wrongApiKey_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
    ...
    @Test
    public void mostViewedItems_apiKeyTenant_shouldReturnRecommendations() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        ...
        assertThat(json.getString("action"), is("mostvieweditems"));
        ...
        assertThat(item.getString("value"), is("2.0"));
        ...
        assertThat(item.getString("value"), is("1.0"));
    ...
    @Test
    public void mostViewedItems_numberOfResults_shouldTruncateResult() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("numberOfResults", "2");
    ...
    @Test
    public void mostViewedItems_requestedItemType_shouldFilterResults() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
