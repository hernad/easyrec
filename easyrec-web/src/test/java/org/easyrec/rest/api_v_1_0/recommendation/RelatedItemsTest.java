...
public abstract class RelatedItemsTest extends AbstractApiTest {

    public static class JSON extends RelatedItemsTest {
        public JSON() throws TestContainerException { super(METHOD_JSON); }
    }

    public static class XML extends RelatedItemsTest {
    ...
    @Test
    public void relatedItems_noParameters_shouldReturnError() {
    ...
    @Test
    public void relatedItems_wrongTenant_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
    ...
    @Test
    public void relatedItems_wrongApiKey_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
    ...
    @Test
    public void relatedItems_onlyApiKeyTenant_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        ...
        assertThat(json.getJSONObject("error").getString("@message"), containsString("Item id required"));
    }

    @Test
    public void relatedItems_noFilter_shouldReturnRecommendationsOfAllItemTypes() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        ...
        assertThat(json, not(is(nullValue())));
        assertThat(json.getString("action"), is("relateditems"));
    ...
    @Test
    public void relatedItems_filterItemType_shouldReturnRecommendationsOfSpecificItemType() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("itemid", "ITEM_A");
    ...
    @Test
    public void relatedItems_numberOfResults_shouldTruncateReults() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("itemid", "ITEM_A");
    ...
    @Test
    public void relatedItems_wrongItemType_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("itemid", "ITEM_A");
    ...
    @SuppressWarnings({"unchecked"})
    @Test
    public void relatedItems_wrongRequestedItemType_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        params.add("itemid", "ITEM_A");
    ...
    @Test
    public void relatedItems_wrongItem_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
    ...
    @Test
    public void relatedItems_deactivatedItem_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
