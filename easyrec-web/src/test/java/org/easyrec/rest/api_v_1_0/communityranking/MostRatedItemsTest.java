...
public abstract class MostRatedItemsTest extends AbstractApiTest {

    public static class JSON extends MostRatedItemsTest {
        public JSON() throws TestContainerException { super(METHOD_JSON); }
    }

    public static class XML extends MostRatedItemsTest {
        public XML() throws TestContainerException { super(METHOD_XML); }
    }

    public MostRatedItemsTest(String method) throws TestContainerException {
        super("mostrateditems", method);
    }

    @Test
    public void mostRatedItems_noParameters_shouldReturnError() {
    ...
    @Test
    public void mostRatedItems_wrongTenant_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
    ...
    @Test
    public void mostRatedItems_wrongApiKey_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
    ...
    @Test
    public void mostRatedItems_apiKeyTenant_shouldReturnRecommendations() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        ...
        assertThat(json.getString("action"), is("mostrateditems"));
    ...
    @Test
    public void mostRatedItems_numberOfResults_shouldTruncateResult() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
    ...
    @Test
    public void mostRatedItems_requestedItemType_shouldFilterResults() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
