...
public abstract class WorstRatedItemsTest extends AbstractApiTest {

    public static class JSON extends WorstRatedItemsTest {
        public JSON() throws TestContainerException { super(METHOD_JSON); }
    }

    public static class XML extends WorstRatedItemsTest {
        public XML() throws TestContainerException { super(METHOD_XML); }
    }

    public WorstRatedItemsTest(String method) throws TestContainerException {
        super("worstrateditems", method);
    }

    @Test
    public void worstRatedItems_noParameters_shouldReturnError() {
    ...
    @Test
    public void worstRatedItems_wrongTenant_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
    ...
    @Test
    public void worstRatedItems_wrongApiKey_shouldReturnError() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
    ...
    @Test
    public void worstRatedItems_apiKeyTenant_shouldReturnRecommendations() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
        ...
        assertThat(item.getString("value"), is("4.5"));
    ...
    @Test
    public void worstRatedItems_numberOfResults_shouldTruncateResult() {
        MultivaluedMap<String, String> params = new MultivaluedMapImpl();
        params.add("tenantid", TENANT_ID);
        params.add("apikey", API_KEY);
